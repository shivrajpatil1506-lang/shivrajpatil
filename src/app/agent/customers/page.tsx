...
import { getCustomersForCurrentUser } from "@/app/actions/customers";
...
export default function AgentCustomersPage() {
  ...
  const fetchData = async () => {
    setLoading(true);
    const data = await getCustomersForCurrentUser();
  ...
  return (
    <div className="animate-fade-in">
      <PageHeader
        title="My Customers"
        description={loading ? "Loading customers..." : `${uniqueCustomerCount} customers in your portfolio`}
        actions={
