    ...
    <div className="animate-fade-in max-w-5xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        ...
        <div className="flex items-center gap-3">
          <Link href="/accounting/ledgers/new" className="inline-flex items-center gap-2 px-4 py-2.5 bg-primary-600 text-white text-sm font-medium rounded-lg hover:bg-primary-700 transition-colors">
        ...
        <div className="bg-white rounded-xl border border-neutral-100 shadow-sm p-2 md:p-6 min-h-[400px]">
          {loading ? (
            ...
            <div className="text-center py-20 text-neutral-500">
              ...
              <Link href="/accounting/settings" className="inline-block mt-4 text-primary-600 hover:underline text-sm font-medium">Go to Settings</Link>
            </div>
          ) : (
