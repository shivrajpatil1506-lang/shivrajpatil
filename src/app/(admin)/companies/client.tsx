...
import { deleteCompany, getCompanies } from "@/app/actions/companies";
import { useToast } from "@/components/ui/Toast";

type CompanyWithCounts = Awaited<ReturnType<typeof getCompanies>>[0];

export function CompaniesClient({ initialData }: { initialData: CompanyWithCounts[] }) {
  const [companies, setCompanies] = useState<CompanyWithCounts[]>(initialData);
