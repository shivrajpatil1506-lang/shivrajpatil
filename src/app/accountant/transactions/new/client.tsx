...
export function AddTransactionClient({ 
  ...
  return (
    <div className="animate-fade-in max-w-3xl mx-auto">
      <Link href="/accountant/transactions" className="inline-flex items-center gap-1.5 text-sm text-neutral-500 hover:text-primary-500 mb-4 transition-colors">
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-end gap-3 pb-6">
          <Link href="/accountant/transactions" className="px-6 py-3 text-sm font-medium border border-neutral-200 text-neutral-700 rounded-lg hover:bg-neutral-50 transition-colors">Cancel</Link>
          <button
