...
export function TransactionsClient({ initialData, companies }: { initialData: TransactionData[], companies: any[] }) {
  ...
  }, [search, companyFilter, categoryFilter, dateFilter, statusFilter, initialData]);
